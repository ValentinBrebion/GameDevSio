...
<div class="overflow-hidden bg-white py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      ...
      <img src="https://imgs.search.brave.com/SvNyvKjH0tqmClgeF3qabqib4DSkv8TKR0cgh1zVICI/rs:fit:770:770:1/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzMyL2Zl/LzBlLzMyZmUwZTJk/ZDlhNmE3MzdkNDM2/ZjdjNDA5NWNkMjk4/LnBuZw" class="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442">
    </div>
  </div>
</div>
